...
print("| estava em uma tempestade que foi tão forte que fez o barco se acidentar em rochas proximas " .. "\n| levando oito dias para o barco ser reparado.")
print("| ")
print("| ")
...
print("| ")
print("| ")
print("| Então em seu tricentésimo vigésimo quinto dia nosso " .. monsterName .." Retorna a sua casa tendo perdido e ganho atributos. ")
print("| ")
print("| ")
